...
const ensureProductCatalogSchema = async () => {
  ...
  try {
    ...
    console.error(
      "Product catalog schema setup failed. Ensure backend/migrations/add_product_categories_units_pricing.sql is applied and products has category_id, unit, wholesale_price, and image_url columns.",
      error.message
    );
    throw error;
  }
