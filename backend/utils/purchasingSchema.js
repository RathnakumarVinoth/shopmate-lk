...
const ensureStockMovementReferences = async (connection) => {
...
const ensurePurchasingSchema = async () => {
  if (purchasingSchemaReady) return;
  ...
  await ensureStockMovementReferences(connection);
  await addIndexIfMissing(
    connection,
    "stock_batches",
    "idx_stock_batches_received_date",
    "(shop_id, received_date)"
  );

  purchasingSchemaReady = true;
};

module.exports = { ensurePurchasingSchema };
